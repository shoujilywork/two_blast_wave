...
int main() {
    ...
    while (tolerance > 0.0001) {
            for (int i = 0; i < 50; i++) {
                // 第一步
                MatrixXd fp1, fp2, fp3, fp4, fn1, fn2, fn3, fn4, gp1, gp2, gp3, gp4, gn1, gn2, gn3, gn4;
                split_lf(rho, p, u, v, E,
                         fp1, fp2, fp3, fp4,
                         fn1, fn2, fn3, fn4,
                         gp1, gp2, gp3, gp4,
                         gn1, gn2, gn3, gn4);
